    ...
    <div class="max-w-7xl mx-auto">
        <div class="flex justify-between items-center mb-8">
            ...
            <div class="flex gap-2">
                <a href="export.php" target="_blank" class="px-4 py-2 text-sm font-bold text-emerald-600 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition flex items-center gap-2">
                    ...
                    <table class="w-full text-left text-sm whitespace-nowrap">
                        <thead class="bg-gray-50/50 border-b border-gray-100">
                            <tr>
                                ...
                                <th class="px-6 py-4 font-bold text-gray-600 uppercase text-xs tracking-wider">Gender</th>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm relative overflow-hidden group">
                    <div class="absolute top-0 right-0 p-3 opacity-10 group-hover:scale-110 transition">
                        <svg class="w-12 h-12" fill="currentColor" viewBox="0 0 24 24"><path d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>
                    </div>
                    <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Total Page Views</p>
                    <h2 id="ana-page-view" class="text-3xl font-black text-gray-900 tracking-tighter">0</h2>
                </div>
                
                <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm relative overflow-hidden group">
                    <div class="absolute top-0 right-0 p-3 opacity-10 group-hover:scale-110 transition">
                        <svg class="w-12 h-12" fill="currentColor" viewBox="0 0 24 24"><path d="M9 5v14l11-7L9 5z"/></svg>
                    </div>
                    <p class="text-[10px] font-black text-indigo-500 uppercase tracking-widest mb-1">Klik Tombol Daftar</p>
                    <h2 id="ana-click-register" class="text-3xl font-black text-gray-900 tracking-tighter">0</h2>
                ...
                <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm relative overflow-hidden group">
                    ...
                    <p class="text-[10px] font-black text-emerald-500 uppercase tracking-widest mb-1">Klik Konfirmasi WA</p>
                    <h2 id="ana-click-wa" class="text-3xl font-black text-gray-900 tracking-tighter">0</h2>
                </div>
            </div>

            <div class="flex justify-end mt-4">
                <button onclick="loadStats()" class="px-4 py-2 bg-gray-900 text-white font-bold rounded-lg hover:bg-black transition text-xs flex items-center gap-2">
        ...
        function renderTable(rows) {
            ...
            rows.forEach((row, index) => {
                ...
                tr.innerHTML = `
                    ...
                    <td class="px-6 py-4">
                        <span class="px-2 py-1 rounded text-[10px] font-bold ${row.gender === 'Laki-laki' ? 'bg-blue-50 text-blue-600 border border-blue-100' : (row.gender === 'Perempuan' ? 'bg-pink-50 text-pink-600 border border-pink-100' : 'bg-gray-50 text-gray-400 border border-gray-100')} uppercase">
                            ${row.gender || '-'}
                        </span>
                    </td>
                    <td class="px-6 py-4">
